...
<section className="bg-center min-h-screen bg-no-repeat bg-gray-700 bg-cover bg-blend-multiply"  style={{ backgroundImage: 'url("/background4.jpg")' }}>
    <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">Effortlessly Manage Projects and Collaborate Seamlessly</h1>
        <p className="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">Simplify your project management with our powerful platform. Assign tasks, track progress, and boost productivity—all in one place. Start today and transform the way your team works.</p>
